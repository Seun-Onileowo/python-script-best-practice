...
def get_smallest_prime_factor(n):
    """
    Returns the smallest integer that is a factor of 'n'. If 'n' is a prime number 'None' is returned.
    ...
    int or None
        The smallest integer that is a factor of 'n' or None if 'n' is prime.
